...
- Prometheus - система мониторинга и временных рядов, которая может использоваться для сбора логов от сервисов.
- Prometheus обеспечивает сбор логов из stdout, минимизируя требования к приложениям.
- Собранные логи могут быть сохранены в хранилище, таком как TimescaleDB или InfluxDB, для последующего анализа.
- Grafana предоставляет возможность создания пользовательского интерфейса для поиска, фильтрации, визуализации и анализа логов, а также создание сохраненных поисков, которые можно передавать в виде ссылок.

В виду того, что ELK-стек сейчас недоступен, в итоге остается второй вариант.
